...
async function main() {
    ...
    const stagingComposer = await new OneDeltaComposerMantle__factory(operator).attach(stagingProxy)
    // add new
    cut.push({
