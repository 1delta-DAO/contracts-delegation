export const templateBalancerV3 = (constants: string, switchCaseContent: string, multi = false) => `// SPDX-License-Identifier: BUSL-1.1
...
/**
 * @title Contract Module taking Balancer V3 vault flash loan callbacks
 */
abstract contract BalancerV3FlashLoanCallback is Masks, DeltaErrors {
    // v3 vault addresses
    ${constants}
    /**
    ...
    function balancerUnlockCallback(bytes calldata) external {
        ...
        /**
         * Execute composer commands under the flash-loan context.
         * The Balancer V3 vault lock is released by matching take/settle calls
         * inside the composed payload (see singleton actions).
         */
