 ...
 */
abstract contract MarginTrading is BaseLending, BaseSwapper, V2ReferencesMantle, V3ReferencesMantle, PreFunder {
    // errors
    error NoBalance();
    ...
    // fusionx
    function fusionXV3SwapCallback(int256 amount0Delta, int256 amount1Delta, bytes calldata path) external {
        address tokenIn;
        address tokenOut;
        uint256 pathLength;
        assembly {
    ...
    // agni
    function agniSwapCallback(int256 amount0Delta, int256 amount1Delta, bytes calldata path) external {
        address tokenIn;
        address tokenOut;
        uint256 pathLength;
        assembly {
    ...
    function swapY2XCallback(uint256 x, uint256 y, bytes calldata path) external {
        ...
        clSwapCallback(-int256(x), int256(y), tokenIn, tokenOut, pathLength);
    }
    ...
    function FusionXCall(address sender, uint256 amount0, uint256 amount1, bytes calldata path) external {
        address tokenIn;
        address tokenOut;
        uint256 pathLength;
    ...
    function tropicalCall(address sender, uint256 amount0, uint256 amount1, bytes calldata path) external {
        address tokenIn;
        address tokenOut;
        uint256 pathLength;
        // the fee parameter in the path can be ignored for validating a V2 pool
    ...
    function moeCall(address sender, uint256 amount0, uint256 amount1, bytes calldata path) external {
        address tokenIn;
        address tokenOut;
        uint256 pathLength;
        // the fee parameter in the path can be ignored for validating a V2 pool
    ...
    function hook(address sender, uint256 amount0, uint256 amount1, bytes calldata path) external {
        address tokenIn;
        address tokenOut;
        uint256 pathLength;
        // the fee parameter in the path can be ignored for validating a V2 pool
    ...
    function flashSwapExactInInternal(uint256 amountIn, uint256 amountOutMinimum, address payer, uint256 pathOffset, uint256 pathLength) internal {
        ...
        // iZi
            ...
            _swapIZIPoolExactIn(amountIn, amountOutMinimum, payer, receiver, pathOffset, pathLength);
        }
        // uniswapV2 types
        else if (poolId < UNISWAP_V2_MAX_ID) {
