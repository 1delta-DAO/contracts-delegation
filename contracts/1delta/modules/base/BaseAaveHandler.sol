...
abstract contract BaseAaveHandler {
    address internal immutable nativeWrapper;
    address internal immutable aavePool;

    constructor(address _nativeWrapper, address _aavePool) {
    ...
    function pool(address underlying) internal view virtual returns (IPool);
