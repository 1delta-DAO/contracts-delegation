...
import {V2ReferencesHemi} from "./swappers/V2References.sol";
import {V3ReferencesHemi} from "./swappers/V3References.sol";
 ...
 */
abstract contract MarginTrading is BaseLending, BaseSwapper, V2ReferencesHemi, V3ReferencesHemi, PreFunder {
    // errors
    error NoBalance();
