...
contract AaveV2FlashLoanCallback is Masks, DeltaErrors {
    // Aave v2s
    address private constant LENDLE = 0xCFa5aE7c2CE8Fadc6426C1ff872cA45378Fb7cF3;
    address private constant AURELIUS = 0x7c9C6F5BEd9Cfe5B9070C7D3322CF39eAD2F9492;
        ...
        returns (bool)
    {
        ...
        assembly {
            ...
            switch source
            case 1 {
                if xor(caller(), LENDLE) {
                    mstore(0, INVALID_CALLER)
                    revert(0, 0x4)
                }
            }
            case 2 {
                if xor(caller(), AURELIUS) {
                    mstore(0, INVALID_CALLER)
                    revert(0, 0x4)
                }
            }
