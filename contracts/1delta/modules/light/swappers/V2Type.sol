    ...
    function swapUniV2ExactIn(
        ...
        assembly {
            ...
            // Compute the buy amount based on the pair reserves.
            {
                let zeroForOne := lt(
                    tokenIn_reserveIn,
                    and(ADDRESS_MASK, calldataload(add(currentOffset, 32))) // tokenOut
                )
                // Pairs are in the range (0, 2¹¹²) so this shouldn't overflow.
                ...
                case 1 {
                    ...
                    calldatacopy(calldataOffsetStart, currentOffset, _pathLength)
                    // store max amount
