...
import {KTXQuoterArbitrum} from "./dex/KTXArbitrum.sol";
import {GMXQuoterArbitrum} from "./dex/GMXArbitrum.sol";
    ...
    function quoteExactInput(
        ...
        while (true) {
            ...
            // v2 types
                ...
                amountIn = getGMXAmountOut(tokenIn, tokenOut, pair, amountIn);
                path = path[EXOTIC_PARAM_LENGTH:];
