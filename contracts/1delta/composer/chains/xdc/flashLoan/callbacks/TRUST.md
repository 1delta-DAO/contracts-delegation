...
protocol's canonical deployment on xdc, and for upgradeable pools record who controls the
proxy admin.
...
| constant | address |
|----------|---------|
| `PRIME_FI` | `0x8a619D8E3BfAb54F7C30Ef39Ce16c53429c739C3` |
...
| constant | address |
|----------|---------|
| `FATHOM` | `0x70d8005E3c8C7e383FE35Fa40156042F3393449F` |
