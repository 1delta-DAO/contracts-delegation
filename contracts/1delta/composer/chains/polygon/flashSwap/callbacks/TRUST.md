# Callback Trust Assessment — polygon
...
protocol's canonical deployment on polygon, and for upgradeable pools record who controls the
proxy admin.
...
| constant | address |
|----------|---------|
| `UNISWAP_V4` | `0x67366782805870060151383F4BbFF9daB53e5cD6` |
