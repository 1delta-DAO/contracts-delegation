...
abstract contract UniV2Callbacks is Masks, DeltaErrors {
    ...
    bytes32 private constant VVS_V2_FF_FACTORY = 0xff9fAb572F75008A42c6aF80b36Ab20C76a38ABc4B0000000000000000000000;
    bytes32 private constant VVS_V2_CODE_HASH = 0xa77ee1cc0f39570ddde947459e293d7ebc2c30ff4e8fc45860afdcb2c2d3dc17;
    ...
    function _executeUniV2IfSelector(bytes32 selector) internal {
        ...
        assembly {
            ...
            switch selector
            case 0x38d7b3cb00000000000000000000000000000000000000000000000000000000 {
                forkId := and(UINT8_MASK, shr(88, outData))

                ffFactoryAddress := VVS_V2_FF_FACTORY
                codeHash := VVS_V2_CODE_HASH
            }
        }
