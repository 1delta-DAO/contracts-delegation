...
abstract contract UniV3Callbacks is V3Callbacker, Masks, DeltaErrors {
    ...
    bytes32 private constant VVS_V3_FF_FACTORY = 0xff40aB11c64E9fF5368F09343Ac860dAfA34e14C350000000000000000000000;
    bytes32 private constant VVS_V3_CODE_HASH = 0x3ea5f55d6524ce396b6eb0054ae36a854425f2ed4c48b04b78e228656dc0b7de;
    ...
    function _executeUniV3IfSelector(bytes32 selector) internal {
        ...
        assembly {
            switch selector
            case 0xa224ef8300000000000000000000000000000000000000000000000000000000 {
                ffFactoryAddress := VVS_V3_FF_FACTORY
                codeHash := VVS_V3_CODE_HASH
