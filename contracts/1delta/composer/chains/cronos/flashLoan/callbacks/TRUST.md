# Callback Trust Assessment — cronos
...
protocol's canonical deployment on cronos, and for upgradeable pools record who controls the
proxy admin.
...
| constant | address |
|----------|---------|
| `MORPHO_BLUE` | `0xDF9a1DC07e5dEe5ccCCaBeC35e446C70fAF7434e` |
