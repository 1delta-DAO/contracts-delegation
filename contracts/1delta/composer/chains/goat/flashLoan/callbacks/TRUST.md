# Callback Trust Assessment — goat
...
protocol's canonical deployment on goat, and for upgradeable pools record who controls the
proxy admin.
...
| constant | address |
|----------|---------|
| `AVALON` | `0x4B801fb6f0830D070f40aff9ADFC8f6939Cc1F8D` |
