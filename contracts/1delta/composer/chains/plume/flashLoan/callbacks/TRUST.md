# Callback Trust Assessment — plume
...
protocol's canonical deployment on plume, and for upgradeable pools record who controls the
proxy admin.
...
| constant | address |
|----------|---------|
| `LAYERBANK_V3` | `0x83aA6ba98E09A7D4F52Dd171F5a0c49d1916ffD6` |
...
| constant | address |
|----------|---------|
| `MORPHO_BLUE` | `0x42b18785CE0Aed7BF7Ca43a39471ED4C0A3e0bB5` |
