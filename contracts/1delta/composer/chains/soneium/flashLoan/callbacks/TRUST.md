# Callback Trust Assessment — soneium
...
protocol's canonical deployment on soneium, and for upgradeable pools record who controls the
proxy admin.
...
|--------|----------|---------|
| 0 | `AAVE_V3` | `0xDd3d7A7d03D9fD9ef45f3E587287922eF65CA38B` |
| 87 | `SAKE` | `0x3C3987A310ee13F7B8cBBe21D97D4436ba5E4B5f` |
| 88 | `SAKE_ASTAR` | `0x0Bd12d3C4E794cf9919618E2bC71Bdd0C4FF1cF6` |
...
| constant | address |
|----------|---------|
| `MORPHO_BLUE` | `0xE75Fc5eA6e74B824954349Ca351eb4e671ADA53a` |
