...
protocol's canonical deployment on op, and for upgradeable pools record who controls the
proxy admin.
...
| constant | address |
|----------|---------|
| `GRANARY` | `0x8FD4aF47E4E63d1D2D45582c3286b4BD9Bb95DfE` |
...
| 85 | `XLEND` | `0x345D2827f36621b02B783f7D5004B4a2fec00186` |
...
| constant | address |
|----------|---------|
| `MORPHO_BLUE` | `0xce95AfbB8EA029495c66020883F87aaE8864AF92` |
