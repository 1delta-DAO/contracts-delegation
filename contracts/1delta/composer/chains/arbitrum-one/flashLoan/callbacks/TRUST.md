# Callback Trust Assessment — arbitrum-one
...
protocol's canonical deployment on arbitrum-one, and for upgradeable pools record who controls the
proxy admin.
...
|--------|----------|---------|
| 7 | `GRANARY` | `0x102442A3BA1e441043154Bc0B8A2e2FB5E0F94A7` |
| 20 | `RADIANT_V2` | `0xE23B4AE3624fB6f7cDEF29bC8EAD912f1Ede6886` |
...
| poolId | constant | address |
|--------|----------|---------|
| 0 | `AAVE_V3` | `0x794a61358D6845594F94dc1DB02A252b5b4814aD` |
| 50 | `AVALON` | `0xe1ee45DB12ac98d16F1342a03c93673d74527b55` |
| 53 | `AVALON_PUMPBTC` | `0x4B801fb6f0830D070f40aff9ADFC8f6939Cc1F8D` |
