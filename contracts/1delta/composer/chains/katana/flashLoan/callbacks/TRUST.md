# Callback Trust Assessment — katana
...
protocol's canonical deployment on katana, and for upgradeable pools record who controls the
proxy admin.
...
| constant | address |
|----------|---------|
| `MORPHO_BLUE` | `0xD50F2DffFd62f94Ee4AEd9ca05C61d0753268aBc` |
