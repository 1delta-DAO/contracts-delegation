# Callback Trust Assessment — megaeth
...
protocol's canonical deployment on megaeth, and for upgradeable pools record who controls the
proxy admin.
...
| constant | address |
|----------|---------|
| `AAVE_V3` | `0x7e324AbC5De01d112AfC03a584966ff199741C28` |
