# Callback Trust Assessment — celo
...
protocol's canonical deployment on celo, and for upgradeable pools record who controls the
proxy admin.
...
| constant | address |
|----------|---------|
| `AAVE_V3` | `0x3E59A31363E2ad014dcbc521c4a0d5757d9f3402` |
...
| constant | address |
|----------|---------|
| `MORPHO_BLUE` | `0xd24ECdD8C1e0E57a4E26B1a7bbeAa3e95466A569` |
