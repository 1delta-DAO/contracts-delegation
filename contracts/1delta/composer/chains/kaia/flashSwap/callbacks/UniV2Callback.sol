...
abstract contract UniV2Callbacks is Masks, DeltaErrors {
    ...
    bytes32 private constant DRAGONSWAP_V2_FF_FACTORY = 0xff724412C00059bf7d6ee7d4a1d0D5cd4de3ea1C480000000000000000000000;
    bytes32 private constant DRAGONSWAP_V2_CODE_HASH = 0x1f07efc9aeaf9f1a5259be7f0e4bd52396274fcf450ef2efd01a1ac8965b12b2;
    ...
    function _executeUniV2IfSelector(bytes32 selector) internal {
        ...
        assembly {
            ...
            case 0x8480081200000000000000000000000000000000000000000000000000000000 {
                ...
                ffFactoryAddress := DRAGONSWAP_V2_FF_FACTORY
                codeHash := DRAGONSWAP_V2_CODE_HASH
            }
        }
