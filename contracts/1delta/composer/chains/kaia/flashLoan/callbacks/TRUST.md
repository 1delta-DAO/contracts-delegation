# Callback Trust Assessment — kaia
...
protocol's canonical deployment on kaia, and for upgradeable pools record who controls the
proxy admin.
...
|--------|----------|---------|
| 15 | `KLAP` | `0x1b9c074111ec65E1342Ea844f7273D5449D2194B` |
| 16 | `KLAYBANK` | `0x4B6Ece52D0EF60aE054f45c45D6bA4F7a0C2cC67` |
...
| poolId | constant | address |
|--------|----------|---------|
| 50 | `AVALON` | `0xCf1af042f2A071DF60a64ed4BdC9c7deE40780Be` |
| 55 | `AVALON_USDA` | `0x65bB26fa8D2774313202029619767A3727C98B1b` |
| 56 | `AVALON_SKAIA` | `0x4659F938458afB37F3340270FC9CdFe665809c1b` |
| 86 | `RHOMBUS` | `0xc17bDf95aBD73B851917B6233090E025427e1e84` |
