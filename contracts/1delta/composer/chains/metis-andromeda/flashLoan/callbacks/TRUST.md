# Callback Trust Assessment — metis-andromeda
...
protocol's canonical deployment on metis-andromeda, and for upgradeable pools record who controls the
proxy admin.
...
| constant | address |
|----------|---------|
| `GRANARY` | `0x65dEc665ea1e96Ee5203DB321b5Cd413b81B2bd2` |
...
| constant | address |
|----------|---------|
| `AAVE_V3` | `0x90df02551bB792286e8D4f13E0e357b4Bf1D6a57` |
