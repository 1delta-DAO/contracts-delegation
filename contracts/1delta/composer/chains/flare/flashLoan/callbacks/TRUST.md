# Callback Trust Assessment — flare
...
protocol's canonical deployment on flare, and for upgradeable pools record who controls the
proxy admin.
...
| constant | address |
|----------|---------|
| `MORPHO_BLUE` | `0xF4346F5132e810f80a28487a79c7559d9797E8B0` |
