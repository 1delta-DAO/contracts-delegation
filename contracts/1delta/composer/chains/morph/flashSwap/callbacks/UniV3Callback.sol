...
abstract contract UniV3Callbacks is V3Callbacker, Masks, DeltaErrors {
    ...
    bytes32 private constant MOR_FI_FF_FACTORY = 0xffC1db2471EA7ea9227Ea02f427543177d63AFe44Fffffffffffffffffffffff;
    bytes32 private constant MOR_FI_CODE_HASH = 0xb3fc09be5eb433d99b1ec89fd8435aaf5ffea75c1879e19028aa2414a14b3c85;
    ...
    function _executeUniV3IfSelector(bytes32 selector) internal {
        ...
        assembly {
            ...
            case 0x2c8958f600000000000000000000000000000000000000000000000000000000 {
                ffFactoryAddress := MOR_FI_FF_FACTORY
                codeHash := MOR_FI_CODE_HASH
