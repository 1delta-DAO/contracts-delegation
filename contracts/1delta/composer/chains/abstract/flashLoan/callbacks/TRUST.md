# Callback Trust Assessment — abstract
...
protocol's canonical deployment on abstract, and for upgradeable pools record who controls the
proxy admin.
...
| constant | address |
|----------|---------|
| `ZEROLEND` | `0xFC1ef22b9458F112Ef4EB6BF1c537776f0341185` |
...
| constant | address |
|----------|---------|
| `MORPHO_BLUE` | `0xc85CE8ffdA27b646D269516B8d0Fa6ec2E958B55` |
