# Callback Trust Assessment — stable
...
protocol's canonical deployment on stable, and for upgradeable pools record who controls the
proxy admin.
...
| constant | address |
|----------|---------|
| `MORPHO_BLUE` | `0xa40103088A899514E3fe474cD3cc5bf811b1102e` |
