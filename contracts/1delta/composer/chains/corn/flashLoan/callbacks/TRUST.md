# Callback Trust Assessment — corn
...
protocol's canonical deployment on corn, and for upgradeable pools record who controls the
proxy admin.
...
|--------|----------|---------|
| 20 | `ZEROLEND` | `0x927b3A8e5068840C9758b0b88207b28aeeb7a3fd` |
| 50 | `AVALON` | `0xd412D77A4920317ffb3F5deBAD29B1662FBA53DF` |
| 51 | `AVALON_SOLVBTC` | `0xd63C731c8fBC672B69257f70C47BD8e82C9efBb8` |
| 53 | `AVALON_PUMPBTC` | `0xdef0EB584700Fc81C73ACcd555cB6cea5FB85C3e` |
| 55 | `AVALON_USDA` | `0xf659a3fa012f5847067239a6009309323011815d` |
| 66 | `AVALON_LBTC` | `0xC1bFbF4E0AdCA79790bfa0A557E4080F05e2B438` |
...
| constant | address |
|----------|---------|
| `MORPHO_BLUE` | `0xc2B1E031540e3F3271C5F3819F0cC7479a8DdD90` |
