...
protocol's canonical deployment on sei, and for upgradeable pools record who controls the
proxy admin.
...
|--------|----------|---------|
| 50 | `AVALON` | `0xE5eB6aBbA365A49C8624532acaed54A47cc36D3C` |
| 55 | `AVALON_USDA` | `0xC1bFbF4E0AdCA79790bfa0A557E4080F05e2B438` |
| 102 | `YEI` | `0x4a4d9abD36F923cBA0Af62A39C01dEC2944fb638` |
| 103 | `YEI_SOLV` | `0x7b5b1A719d54664657451db7600FD5C3ca0fa136` |
...
| constant | address |
|----------|---------|
| `MORPHO_BLUE` | `0xc9cDAc20FCeAAF616f7EB0bb6Cd2c69dcfa9094c` |
