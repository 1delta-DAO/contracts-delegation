...
abstract contract UniV2Callbacks is Masks, DeltaErrors {
    ...
    bytes32 private constant KODIAK_V2_FF_FACTORY = 0xff5e705e184D233FF2A7cb1553793464a9d0C3028F0000000000000000000000;
    bytes32 private constant KODIAK_V2_CODE_HASH = 0x190cc7bdd70507a793b76d7bc2bf03e1866989ca7881812e0e1947b23e099534;
    ...
    function _executeUniV2IfSelector(bytes32 selector) internal {
        ...
        assembly {
            ...
            case 0x10d1e85c00000000000000000000000000000000000000000000000000000000 {
                ...
                ffFactoryAddress := KODIAK_V2_FF_FACTORY
                codeHash := KODIAK_V2_CODE_HASH
            }
        }
