# Callback Trust Assessment — linea
...
protocol's canonical deployment on linea, and for upgradeable pools record who controls the
proxy admin.
...
| constant | address |
|----------|---------|
| `GRANARY` | `0x871AfF0013bE6218B61b28b274a6F53DB131795F` |
...
|--------|----------|---------|
| 0 | `AAVE_V3` | `0xc47b8C00b0f69a36fa203Ffeac0334874574a8Ac` |
| 20 | `ZEROLEND` | `0x2f9bB73a8e98793e26Cb2F6C4ad037BDf1C6B269` |
| 24 | `ZEROLEND_CROAK` | `0xc6ff96AefD1cC757d56e1E8Dcc4633dD7AA5222D` |
| 25 | `ZEROLEND_FOXY` | `0xbDAa004A456E7f2dAff00FfcDCbEaD5da27B7966` |
...
| constant | address |
|----------|---------|
| `MORPHO_BLUE` | `0x6B0D716aC0A45536172308e08fC2C40387262c9F` |
