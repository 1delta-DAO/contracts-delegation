...
abstract contract UniV3Callbacks is V3Callbacker, Masks, DeltaErrors {
    ...
    bytes32 private constant UNISWAP_V3_FF_FACTORY = 0xff31FAfd4889FA1269F7a13A66eE0fB458f27D72A90000000000000000000000;
    ...
    function _executeUniV3IfSelector(bytes32 selector) internal {
        ...
        assembly {
            ...
            case 0x654b648700000000000000000000000000000000000000000000000000000000 {
                ffFactoryAddress := NILE_CL_FF_FACTORY
                codeHash := NILE_CL_CODE_HASH
            ...
            case 0x2c8958f600000000000000000000000000000000000000000000000000000000 {
                ...
                case 30 {
                    ffFactoryAddress := HORIZON_FF_FACTORY
                    codeHash := HORIZON_CODE_HASH
                }
                default { revert(0, 0) }
                let _amount1 := calldataload(36)
                switch sgt(_amount1, 0)
