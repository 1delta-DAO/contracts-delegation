...
contract AaveV3FlashLoanCallback is Masks, DeltaErrors {
    ...
    address private constant BETTER_BANK = 0xEC521218747d6ac1b3a9BD72a6F81Cb130309889;
    address private constant BETTER_BANK_ATROPA = 0x000dEdABed8122422FfBA497458C4bd6cC4F69f7;
        ...
        returns (bool)
    {
        ...
        assembly {
            ...
            case 102 { pool := BETTER_BANK }
            case 103 { pool := BETTER_BANK_ATROPA }
