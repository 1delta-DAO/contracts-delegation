...
abstract contract UniV2Callbacks is Masks, DeltaErrors {
    ...
    bytes32 private constant NINEMM_V2_FF_FACTORY = 0xff3a0Fa7884dD93f3cd234bBE2A0958Ef04b05E13b0000000000000000000000;
    bytes32 private constant NINEMM_V2_CODE_HASH = 0x21c2480291271d59dc471d22866dcd47b2cf3de1cfb32000578a8752022a6b83;

    bytes32 private constant PULSX_V1_FF_FACTORY = 0xff1715a3E4A142d8b698131108995174F37aEBA10D0000000000000000000000;
    bytes32 private constant PULSX_V1_CODE_HASH = 0x59fffffddd756cba9095128e53f3291a6ba38b21e3df744936e7289326555d62;
    ...
    function _executeUniV2IfSelector(bytes32 selector) internal {
        ...
        assembly {
            ...
            case 0x8480081200000000000000000000000000000000000000000000000000000000 {
                ...
                ffFactoryAddress := NINEMM_V2_FF_FACTORY
                codeHash := NINEMM_V2_CODE_HASH
            }
            case 0x10d1e85c00000000000000000000000000000000000000000000000000000000 {
                forkId := and(UINT8_MASK, shr(88, outData))

                ffFactoryAddress := PULSX_V1_FF_FACTORY
                codeHash := PULSX_V1_CODE_HASH
            }
        }
