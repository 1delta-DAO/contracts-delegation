...
abstract contract UniV3Callbacks is V3Callbacker, Masks, DeltaErrors {
    ...
    bytes32 private constant NINEMM_V3_FF_FACTORY = 0xff00f37661fA1b2B8A530cfb7B6d5A5a6AEd74177b0000000000000000000000;
    bytes32 private constant NINEMM_V3_CODE_HASH = 0x6ce8eb472fa82df5469c6ab6d485f17c3ad13c8cd7af59b3d4a8026c5ce0f7e2;
    ...
    function _executeUniV3IfSelector(bytes32 selector) internal {
        ...
        assembly {
            ...
            case 0x23a69e7500000000000000000000000000000000000000000000000000000000 {
                ffFactoryAddress := NINEMM_V3_FF_FACTORY
                codeHash := NINEMM_V3_CODE_HASH
