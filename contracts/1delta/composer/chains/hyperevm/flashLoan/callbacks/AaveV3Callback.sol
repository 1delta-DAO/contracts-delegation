...
contract AaveV3FlashLoanCallback is Masks, DeltaErrors {
    ...
    address private constant HYPERYIELD = 0xC0Fd3F8e8b0334077c9f342671be6f1a53001F12;
    address private constant HYPERLEND = 0x00A89d7a5A02160f20150EbEA7a2b5E4879A1A8b;
    address private constant HYPURRFI = 0xceCcE0EB9DD2Ef7996e01e25DD70e461F918A14b;
        ...
        returns (bool)
    {
        ...
        assembly {
            ...
            case 63 { pool := HYPERYIELD }
            case 81 { pool := HYPERLEND }
            case 83 { pool := HYPURRFI }
