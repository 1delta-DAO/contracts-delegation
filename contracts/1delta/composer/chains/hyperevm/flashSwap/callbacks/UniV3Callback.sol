...
abstract contract UniV3Callbacks is V3Callbacker, Masks, DeltaErrors {
    ...
    bytes32 private constant HYPERSWAP_V3_FF_FACTORY = 0xffB1c0fa0B789320044A6F623cFe5eBda9562602E30000000000000000000000;
    bytes32 private constant HYPERSWAP_V3_CODE_HASH = 0xe3572921be1688dba92df30c6781b8770499ff274d20ae9b325f4242634774fb;
    ...
    function _executeUniV3IfSelector(bytes32 selector) internal {
        ...
        assembly {
            ...
            case 0xfa461e3300000000000000000000000000000000000000000000000000000000 {
                ffFactoryAddress := HYPERSWAP_V3_FF_FACTORY
                codeHash := HYPERSWAP_V3_CODE_HASH
