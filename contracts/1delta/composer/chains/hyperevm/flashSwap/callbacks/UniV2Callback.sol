...
abstract contract UniV2Callbacks is Masks, DeltaErrors {
    ...
    bytes32 private constant HYPERSWAP_V2_FF_FACTORY = 0xff724412C00059bf7d6ee7d4a1d0D5cd4de3ea1C480000000000000000000000;
    bytes32 private constant HYPERSWAP_V2_CODE_HASH = 0xc83d9df19c8c8a0a1229bd3122cbb86fd8ff56f79cc6781c15999d39425466e9;
    ...
    function _executeUniV2IfSelector(bytes32 selector) internal {
        ...
        assembly {
            ...
            case 0x10d1e85c00000000000000000000000000000000000000000000000000000000 {
                ...
                ffFactoryAddress := HYPERSWAP_V2_FF_FACTORY
                codeHash := HYPERSWAP_V2_CODE_HASH
            }
        }
