# Callback Trust Assessment — zksync
...
protocol's canonical deployment on zksync, and for upgradeable pools record who controls the
proxy admin.
...
| constant | address |
|----------|---------|
| `AAVE_V3_POOL` | `0x78e30497a3c7527d953c6B1E3541b021A98Ac43c` |
