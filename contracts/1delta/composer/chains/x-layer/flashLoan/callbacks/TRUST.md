# Callback Trust Assessment — x-layer
...
protocol's canonical deployment on x-layer, and for upgradeable pools record who controls the
proxy admin.
...
|--------|----------|---------|
| 0 | `AAVE_V3` | `0xE3F3Caefdd7180F884c01E57f65Df979Af84f116` |
| 20 | `ZEROLEND` | `0xfFd79D05D5dc37E221ed7d3971E75ed5930c6580` |
