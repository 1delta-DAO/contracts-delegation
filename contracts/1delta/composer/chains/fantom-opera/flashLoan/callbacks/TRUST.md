# Callback Trust Assessment — fantom-opera
...
protocol's canonical deployment on fantom-opera, and for upgradeable pools record who controls the
proxy admin.
...
| constant | address |
|----------|---------|
| `GRANARY` | `0x65FA36Fe0a7C0d346Dd02b7217Fdd6E6C5aaA269` |
