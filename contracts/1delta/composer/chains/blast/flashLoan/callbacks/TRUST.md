# Callback Trust Assessment — blast
...
protocol's canonical deployment on blast, and for upgradeable pools record who controls the
proxy admin.
...
| constant | address |
|----------|---------|
| `SEISMIC` | `0x83d55e27b8033b6D5874CBb3c9252c4Bfdb2bC75` |
...
|--------|----------|---------|
| 20 | `ZEROLEND` | `0xa70B0F3C2470AbBE104BdB3F3aaa9C7C54BEA7A8` |
| 81 | `PAC` | `0xd2499b3c8611E36ca89A70Fda2A72C49eE19eAa8` |
