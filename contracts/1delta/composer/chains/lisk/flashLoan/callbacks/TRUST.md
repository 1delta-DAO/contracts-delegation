# Callback Trust Assessment — lisk
...
protocol's canonical deployment on lisk, and for upgradeable pools record who controls the
proxy admin.
...
| constant | address |
|----------|---------|
| `MORPHO_BLUE` | `0x00cD58DEEbd7A2F1C55dAec715faF8aed5b27BF8` |
