...
contract Comptroller is ComptrollerV11Storage, ComptrollerInterfaceG2, ComptrollerErrorReporter, ExponentialNoError {
    ...
    event NewPriceOracle(BscPriceOracle oldPriceOracle, BscPriceOracle newPriceOracle);
     ...
     */
    function _setPriceOracle(BscPriceOracle newOracle) external returns (uint) {
