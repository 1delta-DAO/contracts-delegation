...
import { ONE_18, addBalancer, initAaveBroker, AaveBrokerFixtureInclV2, aaveBrokerFixtureInclV2 } from '../shared/aaveBrokerFixture';
...
describe('Balancer Flash loans for AAVE', async () => {
    ...
    before('Deploy Account, Trader, Uniswap and AAVE', async () => {
        ...
        await mockBalancer.setFlashFee(flashFee)
        ...
        await initAaveBroker(deployer, broker, aaveTest.pool.address)
    ...
    it('allows exact in margin close', async () => {
        ...
        await balancerModule.connect(test).executeOnBalancer(
            tokenIn.address,  // the asset to flash
        ...
        expect((balanceOut).toString()).to.equal((balPre.sub(amountToWithdraw)).toString())
    ...
    it('allows exact out margin close', async () => {
        ...
        await balancerModule.connect(test1).executeOnBalancer(
            tokenIn.address,  // the asset to flash
        ...
        expect((debtBalancePre.sub(amountToRepay))).to.equal(debtBalanceOut.toString())
    ...
    it('allows exact in collateral swap', async () => {
        ...
        await balancerModule.connect(test2).executeOnBalancer(
            tokenIn.address,  // the asset to flash
            amountToWithdrawPostFee, // the flash loan amount
            params, // oneDelta params
            targetCalldata
        ...
        expect(balanceInBefore.sub(balanceIn).toString()).to.equal(amountToWithdraw.toString())
    ...
    it('allows exact in loan swap', async () => {
        ...
        await balancerModule.connect(gabi).executeOnBalancer(
            tokenIn.address,  // the asset to flash
            amountToBorrowPostFee, // the flash loan amount
            params, // oneDelta params
            targetCalldata
        ...
        expect(debtBalanceIn.sub(debtBalanceInPre).toString()).to.equal(amountToBorrow.toString())
    ...
    it('allows exact out loan swap', async () => {
        ...
        await balancerModule.connect(test3).executeOnBalancer(
            tokenIn.address,  // the asset to flash
    ...
    it('allows all in margin close', async () => {
        ...
        await balancerModule.connect(test4).executeOnBalancer(
            tokenIn.address,  // the asset to flash
            amountToWithdrawPostFee, // the flash loan amount
            params, // oneDelta params
            targetCalldata
    ...
    it('allows all in collateral swap', async () => {
        ...
        await balancerModule.connect(test5).executeOnBalancer(
            tokenIn.address,  // the asset to flash
            amountToWithdrawPostFee, // the flash loan amount
            params, // oneDelta params
            targetCalldata
    ...
    it('allows all out margin close', async () => {
        ...
        await balancerModule.connect(test7).executeOnBalancer(
            tokenIn.address,  // the asset to flash
            amountToWithdrawMax, // the flash loan amount
            params, // oneDelta params
            targetCalldata
    ...
    it('allows all out loan swap', async () => {
        ...
        await balancerModule.connect(test6).executeOnBalancer(
            tokenIn.address,  // the asset to flash
            amountToBorrowMax, // the flash loan amount
            params, // oneDelta params
            targetCalldata
...
// ··························································································|···························|···········|······························
// |  Methods                                                                                ·              32 gwei/gas              ·       1714.95 usd/eth       │
// ························································|·································|·············|·············|···········|···············|··············
// |  Contract                                             ·  Method                         ·  Min        ·  Max        ·  Avg      ·  # calls      ·  usd (avg)  │
// ························································|·································|·············|·············|···········|···············|··············
// |  @openzeppelin/contracts/token/ERC20/ERC20.sol:ERC20  ·  approve                        ·      34108  ·      51244  ·    46948  ·            4  ·       2.58  │
// ························································|·································|·············|·············|···········|···············|··············
// |  AaveMarginTraderInit                                 ·  initAAVEMarginTrader           ·          -  ·          -  ·   115213  ·            1  ·       6.32  │
// ························································|·································|·············|·············|···········|···············|··············
// |  ACLManager                                           ·  addEmergencyAdmin              ·          -  ·          -  ·    50777  ·            1  ·       2.79  │
// ························································|·································|·············|·············|···········|···············|··············
// |  ACLManager                                           ·  addPoolAdmin                   ·          -  ·          -  ·    50821  ·            1  ·       2.79  │
// ························································|·································|·············|·············|···········|···············|··············
// |  ACLManager                                           ·  addRiskAdmin                   ·          -  ·          -  ·    50842  ·            1  ·       2.79  │
// ························································|·································|·············|·············|···········|···············|··············
