...
// deploys AAVEs
export async function initializeMakeSuite(_deployer: SignerWithAddress, scenarion = 0, interestRatesZero = false) {
  ...
  let baseVariableBorrowRate: BigNumber;
  let variableRateSlope1: BigNumber;
  let variableRateSlope2: BigNumber;
  let stableRateSlope1: BigNumber;
  let stableRateSlope2: BigNumber;
  let baseStableRateOffset: BigNumber;
  let stableRateExcessOffset: BigNumber;
  let optimalStableToTotalDebtRatio: BigNumber;

  if (interestRatesZero) {
    baseVariableBorrowRate = ONE_18.div(1000000000)
    variableRateSlope1 = ONE_18.div(1000000000)
    variableRateSlope2 = ONE_18.div(1000000000)
    stableRateSlope1 = ONE_18.div(1000000000)
    stableRateSlope2 = ONE_18.div(1000000000)
    baseStableRateOffset = ONE_18.div(1000000000)
    stableRateExcessOffset = ONE_18.div(1000000000)
    optimalStableToTotalDebtRatio = ONE_18.div(1000000000)
  } else {

    baseVariableBorrowRate = ONE_18.div(100)
    variableRateSlope1 = ONE_18.div(100)
    variableRateSlope2 = ONE_18.div(100)
    stableRateSlope1 = ONE_18.div(100)
    stableRateSlope2 = ONE_18.div(100)
    baseStableRateOffset = ONE_18.div(100)
    stableRateExcessOffset = ONE_18.div(100)
    optimalStableToTotalDebtRatio = ONE_18.div(100)
  }
  ...
  for (let i = 0; i < tokenData.length; i++) {
    ...
    await testEnv.configurator.updateFlashloanPremiumTotal(5)
    await testEnv.configurator.updateFlashloanPremiumToProtocol(4)
    // set mock price
