...
contract LenderRegistry {
    ...
    constructor() {
        ...
        lendingTokens[Chains.ARBITRUM_ONE][Lenders.VENUS][0x82aF49447D8a07e3bd95BD0d56f35241523fBab1] = LenderTokens(
            0x68a34332983f4Bf866768DD6D6E638b02eF5e1f0,
            address(0),
            address(0)
        );
        lendingTokens[Chains.ARBITRUM_ONE][Lenders.VENUS][0xaf88d065e77c8cC2239327C5EDb3A432268e5831] = LenderTokens(
            0x7D8609f8da70fF9027E9bc5229Af4F6727662707,
            address(0),
            address(0)
        );
        lendingTokens[Chains.ARBITRUM_ONE][Lenders.VENUS][0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9] = LenderTokens(
            0xB9F9117d4200dC296F9AcD1e8bE1937df834a2fD,
            address(0),
            address(0)
        );
        lendingTokens[Chains.ARBITRUM_ONE][Lenders.VENUS][0x912CE59144191C1204E64559FE8253a0e49E6548] = LenderTokens(
        ...
        lendingTokens[Chains.ARBITRUM_ONE][Lenders.VENUS_ETH][0x35751007a407ca6FEFfE80b3cB397736D2cf4dbe] = LenderTokens(
            0x246a35E79a3a0618535A469aDaF5091cAA9f7E88,
            address(0),
            address(0)
        );
        lendingTokens[Chains.ARBITRUM_ONE][Lenders.VENUS_ETH][0x82aF49447D8a07e3bd95BD0d56f35241523fBab1] = LenderTokens(
        ...
        lendingTokens[Chains.AVALANCHE_C_CHAIN][Lenders.BENQI][0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB] = LenderTokens(
            0x334AD834Cd4481BB02d09615E7c11a00579A7909,
            address(0),
            address(0)
        );
        lendingTokens[Chains.AVALANCHE_C_CHAIN][Lenders.BENQI][0xc7198437980c041c805A1EDcbA50c1Ce5db95118] = LenderTokens(
            0xc9e5999b8e75C3fEB117F6f73E664b9f3C8ca65C,
            address(0),
            address(0)
        );
        lendingTokens[Chains.AVALANCHE_C_CHAIN][Lenders.BENQI][0x5947BB275c521040051D82396192181b413227A3] = LenderTokens(
            0x4e9f683A27a6BdAD3FC2764003759277e93696e6,
            address(0),
            address(0)
        );
        lendingTokens[Chains.AVALANCHE_C_CHAIN][Lenders.BENQI][0xd586E7F844cEa2F87f50152665BCbc2C279D8d70] = LenderTokens(
            0x835866d37AFB8CB8F8334dCCdaf66cf01832Ff5D,
            address(0),
            address(0)
        );
        lendingTokens[Chains.AVALANCHE_C_CHAIN][Lenders.BENQI][0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664] = LenderTokens(
            0xBEb5d47A3f720Ec0a390d04b4d41ED7d9688bC7F,
            address(0),
            address(0)
        );
        lendingTokens[Chains.AVALANCHE_C_CHAIN][Lenders.BENQI][0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E] = LenderTokens(
            0xB715808a78F6041E46d61Cb123C9B4A27056AE9C,
            address(0),
            address(0)
        );
        lendingTokens[Chains.AVALANCHE_C_CHAIN][Lenders.BENQI][0x9702230A8Ea53601f5cD2dc00fDBc13d4dF4A8c7] = LenderTokens(
            0xd8fcDa6ec4Bdc547C0827B8804e89aCd817d56EF,
            address(0),
            address(0)
        );
        lendingTokens[Chains.AVALANCHE_C_CHAIN][Lenders.BENQI][0x00000000eFE302BEAA2b3e6e1b18d08D69a9012a] = LenderTokens(
        ...
        lendingTokens[Chains.AVALANCHE_C_CHAIN][Lenders.BENQI_AVALANCE_ECOSYSTEM][0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E] = LenderTokens(
            0x6B35Eb18BCA06bD7d66a428eeb45aC7d200C1e4E,
            address(0),
            address(0)
        );
        lendingTokens[Chains.AVALANCHE_C_CHAIN][Lenders.BENQI_AVALANCE_ECOSYSTEM][0x6e84a6216eA6dACC71eE8E6b0a5B7322EEbC0fDd] = LenderTokens(
            0x4036cb0D6BF6b5F17Aa4e05191F86D4b1655b0d9,
            address(0),
            address(0)
        );
        lendingTokens[Chains.AVALANCHE_C_CHAIN][Lenders.BENQI_AVALANCE_ECOSYSTEM][0x00000000eFE302BEAA2b3e6e1b18d08D69a9012a] = LenderTokens(
            0xb7CfB8Ae67E20059021A0D20fc30311a6c67C734,
            address(0),
            address(0)
        );
        lendingTokens[Chains.AVALANCHE_C_CHAIN][Lenders.BENQI_AVALANCE_ECOSYSTEM][0xbc78D84Ba0c46dFe32cf2895a19939c86b81a777] = LenderTokens(
...
library Lenders {
    ...
    function isAave(string memory lender) internal pure returns (bool isAaveFlag) {
        ...
        isAaveFlag =
            _lender == keccak256(abi.encodePacked((AAVE_V3))) ||
            _lender == keccak256(abi.encodePacked((AAVE_V3_PRIME))) ||
            _lender == keccak256(abi.encodePacked((AAVE_V3_ETHER_FI))) ||
            _lender == keccak256(abi.encodePacked((AAVE_V2))) ||
            _lender == keccak256(abi.encodePacked((LENDLE))) ||
            _lender == keccak256(abi.encodePacked((HANA))) ||
            _lender == keccak256(abi.encodePacked((AURELIUS))) ||
            _lender == keccak256(abi.encodePacked((TAKOTAKO))) ||
            _lender == keccak256(abi.encodePacked((MERIDIAN))) ||
            _lender == keccak256(abi.encodePacked((SPARK))) ||
            _lender == keccak256(abi.encodePacked((AVALON_SOLV_BTC))) ||
            _lender == keccak256(abi.encodePacked((AVALON_PUMP_BTC))) ||
            _lender == keccak256(abi.encodePacked((AVALON_SWELL_BTC))) ||
            _lender == keccak256(abi.encodePacked((AVALON_EBTC_LBTC))) ||
            _lender == keccak256(abi.encodePacked((AVALON))) ||
            _lender == keccak256(abi.encodePacked((AVALON_USDA))) ||
            _lender == keccak256(abi.encodePacked((AVALON_SKAIA))) ||
            _lender == keccak256(abi.encodePacked((NEREUS))) ||
            _lender == keccak256(abi.encodePacked((KINZA))) ||
            _lender == keccak256(abi.encodePacked((ZEROLEND_STABLECOINS_RWA))) ||
            _lender == keccak256(abi.encodePacked((ZEROLEND_ETH_LRTS))) ||
            _lender == keccak256(abi.encodePacked((ZEROLEND_BTC_LRTS))) ||
            _lender == keccak256(abi.encodePacked((ZEROLEND))) ||
            _lender == keccak256(abi.encodePacked((ZEROLEND_CROAK))) ||
            _lender == keccak256(abi.encodePacked((ZEROLEND_FOXY))) ||
            _lender == keccak256(abi.encodePacked((GRANARY))) ||
            _lender == keccak256(abi.encodePacked((LORE))) ||
            _lender == keccak256(abi.encodePacked((LENDOS))) ||
    ...
    function isCompoundV3(string memory lender) internal pure returns (bool isCompoundV3Flag) {
        bytes32 _lender = keccak256(abi.encodePacked((lender)));
        isCompoundV3Flag =
            _lender == keccak256(abi.encodePacked((COMPOUND_V3_USDC))) ||
            ...
            _lender == keccak256(abi.encodePacked((COMPOUND_V3_USDC_E))) ||
