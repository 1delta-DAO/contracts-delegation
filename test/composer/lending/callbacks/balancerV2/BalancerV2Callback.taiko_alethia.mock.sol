...
contract BalancerV2FlashLoanCallbackTest is BaseTest, DeltaErrors, Slots {
    ...
    function test_flash_loan_balancerV2_type_symmetric_pool_with_callbacks() public {
        // mock implementation
        replaceLendingPoolWithMock(SYMMETRIC);

        bytes memory params = CalldataLib.encodeBalancerV2FlashLoan(USDC, 1e6, uint8(1), "");
