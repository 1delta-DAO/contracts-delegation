...
contract AaveV3FlashLoanCallbackTest is BaseTest, DeltaErrors {
    ...
    address private AVALON_INNOVATION;
    ...
    function setUp() public virtual {
        string memory chainName = Chains.PHAROS_MAINNET;
    ...
    function test_unit_lending_flashloans_aaveV3_callback_avalon_innovationPool() public {
        // mock implementation
        replaceLendingPoolWithMock(AVALON_INNOVATION);

        bytes memory params = CalldataLib.encodeFlashLoan(USDC, 1e6, AVALON_INNOVATION, uint8(2), uint8(58), sweepCall());
    ...
    function getAddressFromRegistry() internal {
        ...
        AVALON_INNOVATION = chain.getLendingController(Lenders.AVALON_INNOVATION);
    ...
    function populateValidPools() internal {
        ...
        validPools.push(PoolCase({poolId: 58, poolAddr: AVALON_INNOVATION, asset: USDC}));
    }
