...
contract AaveV2FlashLoanCallbackTest is BaseTest, DeltaErrors {
    ...
    function test_flash_loan_aaveV2_type_aave_v2_pool_with_callbacks() public {
        ...
        bytes memory params = CalldataLib.encodeFlashLoan(USDC, 1e6, AAVE_V2, uint8(3), uint8(0), "");
    ...
    function test_flash_loan_aaveV2_type_wrongCaller_revert() public {
        bytes memory params = CalldataLib.encodeFlashLoan(USDC, 1e6, address(mockPool), uint8(3), uint8(0), "");
    ...
    function test_flash_loan_aaveV2_type_fuzz_invalidPoolIds(uint8 poolId) public {
        ...
        bytes memory params = CalldataLib.encodeFlashLoan(USDC, 1e6, AAVE_V2, uint8(3), uint8(poolId), "");
        vm.prank(user);
