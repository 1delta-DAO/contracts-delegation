...
contract AaveV2FlashLoanCallbackTest is BaseTest, DeltaErrors {
    ...
    function test_flash_loan_aaveV2_type_lore_pool_with_callbacks() public {
        ...
        bytes memory params = CalldataLib.encodeFlashLoan(USDC, 1e6, LORE, uint8(3), uint8(8), "");
    ...
    function test_flash_loan_aaveV2_type_wrongCaller_revert() public {
        bytes memory params = CalldataLib.encodeFlashLoan(USDC, 1e6, address(mockPool), uint8(3), uint8(8), "");
    ...
    function test_flash_loan_aaveV2_type_fuzz_invalidPoolIds(uint8 poolId) public {
        ...
        bytes memory params = CalldataLib.encodeFlashLoan(USDC, 1e6, LORE, uint8(3), uint8(poolId), "");
        vm.prank(user);
