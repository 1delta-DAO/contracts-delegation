...
contract ForkTestMantle is DeltaSetup {
    ...
    function test_permit_mantle() external 
    /**
    ...
    // skipt this one for now
    function test_permit_mantle_1() external 
    /**
     * address user, uint8 lenderId
     */
    {
    ...
    // skipt this one for now
    function test_generic_mantle() external 
    /**
     * address user, uint8 lenderId
     */
    {
    ...
    // skipt this one for now
    function test_generic_qa_mantle() external 
    /**
     * address user, uint8 lenderId
     */
    {
    ...
    function getSwapWithPermit() internal pure returns (bytes memory data) {
        ...
        data =
            hex"0091ae002a960e63ccb0e5bde83a8c13e51e1cb91a0000000000000000000000000000160300000000000000000000000016160041cabae6f6ea1ecab08ad02fe02ce9a44f09aebfa20099d39dfbfba9e7eccd813918ffbda10b783ea3b3c600c96de26018a54d51c097160568752c4e3bd6c364ff09";
    }

    function getSwapWithPermit1() internal pure returns (bytes memory data) {
        // this data is incorrect
        data =
            hex"32cda86a272531e8640cd7f1a92c01839911b90bb000640000000000000000000000000000000000000000000000000001d27d81ba8f6277359400cd4e75a255952274ba2cef5e2fb4b585d174f746d0b65bc531ab24908ea5ad581d79d4ac9030a8bb1441a29b65b340a35012840e9a70693e5061e3ecbe890d91";
    }
    ...
    function getSwapDataFull() internal pure returns (bytes memory data) {
        ...
        data =
            hex"";
    }
    ...
    function getQASwapDataFull() internal pure returns (bytes memory data) {
        ...
        //       
        data =
            hex"";
    }
