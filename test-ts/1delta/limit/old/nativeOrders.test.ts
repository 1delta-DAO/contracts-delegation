...
before(async () => {
    ...
    takerToken = await new MockERC20__factory(owner).deploy("Taker", "T", 18)
    ...
    contractWallet = await new TestOrderSignerRegistryWithContractWallet__factory(owner).deploy(zeroEx.address)
